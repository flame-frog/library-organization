...
<body>
    ...
    <form method="POST" action="bookstate.html"><!--action有待修改 -->
        <span class="select" style="letter-spacing: 0px;"><input type="radio" name="id" value="bookid"
                checked="checked" id="bookid"><label for="bookid">图书编号</label></span>
        <span class="select"><input type="radio" name="id" value="bookname" id="bookname"><label
